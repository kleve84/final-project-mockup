...
export const createRecipePageRouteName = 'Create_Recipe_Page';
userRoutes.route('/create-recipe', {
  name: createRecipePageRouteName,
  action() {
    BlazeLayout.render('User_Layout', { main: createRecipePageRouteName });
  },
});
